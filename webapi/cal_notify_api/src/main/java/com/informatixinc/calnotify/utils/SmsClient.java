...
/**
 * Util for sending text message using AWS SNS service
 * 
 * @author Paul Ortiz
 *
 */
public class SmsClient {
	...
	public void send(final String phoneNumber, final String message) {
		...
		smsAttributes.put("AWS.SNS.SMS.SenderID",
				new MessageAttributeValue().withStringValue("CalNotify").withDataType("String"));
		...
		PublishResult result = client.publish(new PublishRequest().withMessage(message).withPhoneNumber(phoneNumber)
